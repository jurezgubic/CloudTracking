...
class TestCloudMatching(unittest.TestCase):
    ...
    def test_exact_match(self):
        ...
        self.assertTrue(self.cloud_tracker.is_match(cloud_t1, cloud_t0),
    ...
    def test_no_match_distance(self):
        ...
        self.assertFalse(self.cloud_tracker.is_match(cloud_t1, cloud_t0),
    ...
    def test_height_specific_drift(self):
        ...
        self.assertTrue(self.cloud_tracker.is_match(cloud_t1_high, cloud_t0_high),
