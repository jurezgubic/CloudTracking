...
"""
    ...
    def test_parse_arrays(self, mcf_file):
        ...
        np.testing.assert_array_almost_equal(z_theta, [0.0, 334.0, 443.0, 970.0, 1523.0])
        np.testing.assert_array_almost_equal(f_theta, [297.59, 300.45, 300.81, 303.27, 305.76])
