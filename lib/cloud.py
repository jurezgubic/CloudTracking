class Cloud:
    ...
    def __repr__(self):
        return f"Cloud(ID: {self.cloud_id}, Size: {self.size}, Surface Area: {self.surface_area}, Max Height: {self.max_height}, Max w : {max_w}, Max w cloudbase: {max_w_cloud_base},  Active: {self.is_active},  Timestep: {self.timestep})"
